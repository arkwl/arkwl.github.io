    ...
    ngOnInit() {
        ...
        var Application = function () {
          ...
          function Application() {
            ...
            this.loader = PIXI.loader.add('https://stefanweck.nl/codepen/alpha.png').add('https://stefanweck.nl/codepen/shine.png').add('https://stefanweck.nl/codepen/background.jpg').add('https://stefanweck.nl/codepen/foreground.jpg').load(function () {
        ...
        var EffectCanvas = function () {
          ...
          function EffectCanvas(width, height, loader) {
            ...
            shaderData.uniforms.vTextureSize.value = [loader.resources['https://stefanweck.nl/codepen/background.jpg'].texture.width, loader.resources['https://stefanweck.nl/codepen/background.jpg'].texture.height];
        ...
        var DropletManager = function () {
          ...
          function DropletManager(stage, loader) {
            ...
            this.smallDropletContainer = DropletPool(Droplet, this.dropletSmallTexture, this.options.poolDroplets.small.min, this.options.poolDroplets.small.max);
            this.largeDropletContainer = DropletPool(LargeDroplet, this.dropletLargeTexture, this.options.poolDroplets.large.min, this.options.poolDroplets.large.max);
          ...
          DropletManager.prototype.update = function update(width, height) {
            (<any>DropletManager).removeLargeOffscreenDroplets(width, height, this.largeDroplets, this.largeDropletContainer);
          ...
          (<any>DropletManager).removeLargeOffscreenDroplets = function removeLargeOffscreenDroplets(width, height, dropletArray, dropletContainer) {
            // Store the length of the array so the for loop doesn't have to do that every run
