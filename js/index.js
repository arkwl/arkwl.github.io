...
var Application = function () {
  ...
  function Application() {
    ...
    this.loader = PIXI.loader.add('https://stefanweck.nl/codepen/alpha.png').add('https://stefanweck.nl/codepen/shine.png').add('https://raw.githubusercontent.com/arkwl/arkwl.github.io/master/images/background6.png').add('https://stefanweck.nl/codepen/foreground.jpg').load(function () {
...
var EffectCanvas = function () {
  ...
  function EffectCanvas(width, height, loader) {
    ...
    shaderData.uniforms.uTextureBackground.value = loader.resources['https://raw.githubusercontent.com/arkwl/arkwl.github.io/master/images/background6.png'].texture;
    shaderData.uniforms.uTextureForeground.value = loader.resources['https://stefanweck.nl/codepen/foreground.jpg'].texture;
    shaderData.uniforms.vTextureSize.value = [loader.resources['https://raw.githubusercontent.com/arkwl/arkwl.github.io/master/images/background6.png'].texture.width, loader.resources['https://raw.githubusercontent.com/arkwl/arkwl.github.io/master/images/background6.png'].texture.height];
